...
export const GrowthDrivenDesignPageTemplate = ({
                                    image,
                                    title,
                                    subheading,
                                    button,
...
const GrowthDrivenDesignPage = ({data}) => {
    const {
        frontmatter: {
            image,
            title,
...
GrowthDrivenDesignPage.propTypes = {
...
export default GrowthDrivenDesignPage;

export const pageQuery = graphql`
    query GrowthDrivenDesignPageTemplate {
        markdownRemark(frontmatter: { templateKey: { eq: "growth-driven-design-page" } }) {
            frontmatter {
                title
                image {
                    childImageSharp {
